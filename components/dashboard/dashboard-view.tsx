  ...
  const recentActivity = [
    {
      id: 1,
      type: "grade",
      message: "Nuevas calificaciones registradas",
      course: courses[0]?.name || "Matemáticas",
      time: "Hace 2 horas",
      icon: FileText,
    },
    {
      ...
      course: courses[1]?.name || "Ciencias",
      time: "Hace 5 horas",
      icon: Users,
    },
    {
      id: 3,
      type: "planning",
      message: "Planeación semanal actualizada",
      course: courses[2]?.name || "Español",
      time: "Hace 1 día",
      icon: Calendar,
    },
    {
      ...
      course: courses[0]?.name || "Historia",
      time: "Hace 2 días",
      icon: AlertTriangle,
    },
  ]
